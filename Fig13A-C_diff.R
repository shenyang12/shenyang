...
library(ggpubr)               #引用包
expFile="panMethyExp.txt"      #表达输入文件
setwd("C:\\Users\\Administrator\\Desktop\\TP53_family_3\\05_diffMeth")                    #设置工作目录
...
NormalNum=NormalNum[NormalNum>=10]
...
for(gene in genelist){
  ...
  p=ggboxplot(rt1, x="CancerType", y="expression", color = "Type",
              ylab=paste0(gene," methylation levels"),
              xlab="Cancer type",
              palette = c("blue","red") )
